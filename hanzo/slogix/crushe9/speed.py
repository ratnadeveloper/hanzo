...
from hanzo.crushor import AdminRightsCheck
from hanzo.crushor.database import is_active_chat, is_nonadmin_chat
from hanzo.crushor.decorators.language import languageCB
from hanzo.crushor.inline import close_markup, speed_markup
